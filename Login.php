...
<input type="submit" name="Submit" class="btn btn-info btn-block text-info bg-dark" value="Login">
Not a member?<a href="Admins.php" class=" text-center text-info" name="button"> Signup Now</a>
</form>
