...
if (isset($_POST["ContactUsSubmit"])) {
  ...
  if (empty($Email)||empty($Message)) {
    ...
    Redirect_to("FullPost.php?id={$SearchQueryParameter}&&author={$Author}");
  }
  else {
...
if(isset($_POST["Submit"])){
  ...
  if(empty($Name)||empty($Email)||empty($Comment)){
    ...
    //////////////@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ INSERT COMMENT @@@@@@@@@@@@@@@@@@@@@@@@@@//////////////////////
    global $ConnectingDB;
    $sql  = "INSERT INTO comments(datetime,name,email,comment,post_author,approvedby,status,post_id)";
    $sql .= "VALUES(:dateTime,:name,:email,:comment,:authorx,'Pending','OFF',:postIdFromURL)";
    $stmt = $ConnectingDB->prepare($sql);
    $stmt -> bindValue(':dateTime',$DateTime);
    $stmt -> bindValue(':name',$Name);
    $stmt -> bindValue(':email',$Email);
    $stmt -> bindValue(':comment',$Comment);
    $stmt -> bindValue(':authorx',$Author);
...
// The default SQL query
  ...
  $Author = $_GET["author"];
  /////////////@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@///////REDIRECTOR IF INVALID URL///////////@@@@@@@@@@@@@@////////////
  if (!isset($PostIdFromURL)||!isset($Author)) {
...
while ($DataRows = $stmt->fetch()) {
  ...
  while ($DataRows = $stmt->fetch()) {
    ...
    ?>
    <div>
    <div class=" media border border-info text-light">
    ...
    <div>
    <form class="" action="FullPost.php?id=<?php echo $SearchQueryParameter ?>&&author=<?php echo $Admin; ?>" method="post">
    <div class="card mb-3 bg-dark">
    <div class="card-header bg-dark">
    <h5 class="FieldInfo bg-dark">Share your thoughts about this post</h5>
    </div>
    <div class="card-body">
    <div class="form-group">
    ...
    <div class="">
    <button type="submit" name="Submit"class="btn btn-info text-info bg-dark">Submit</button>
    </div>
    </div>
    </div>
    </form>
    ...
    <button type="button" class="btn  btn-info text-info bg-dark  text-center text-white" name="button">Subscribe Now</button>
    </div>
    </div>
    </div>
    </div>
    ...
    while ($DataRows = $stmt->fetch()) {
      ...
      while ($DataRows=$stmt->fetch()) {
        ...
        <a style="text-decoration:none;" href="FullPost.php?id=<?php echo $Id ; ?>&&author=<?php echo $Admin; ?>" target="_blank">  <h6 class="lead"><?php echo htmlentities($Title); ?></h6> </a>
