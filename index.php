...
if (isset($_POST["ContactUsSubmit"])) {
  ...
  if (empty($Email)||empty($Message)) {
    ...
    Redirect_to("index.php?page=1#contactusform");
  }
  else {
    global $ConnectingDB;
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top mb-1">
<div class="container">
<a href="Blog.php?page=1" class="navbar-brand">CMSsite</a>
